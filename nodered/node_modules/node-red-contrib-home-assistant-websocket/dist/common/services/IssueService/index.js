...
_IssueService_initialized = new WeakMap(), _IssueService_nodesToCheck = new WeakMap(), _IssueService_issues = new WeakMap(), _IssueService_hiddenIssues = new WeakMap(), _IssueService_updateHandlers = new WeakMap(), _IssueService_tabs = new WeakMap(), _IssueService_instances = new WeakSet(), _IssueService_getChangedNodes = function _IssueService_getChangedNodes(eventData) {
    ...
    let issues = [];
    switch (true) {
        case (0, issue_check_1.isActionNodeProperties)(node): {
            issues = (0, issue_check_1.default)(node);
            break;
        }
        case (0, issue_check_2.isCurrentStateNodeProperties)(node): {
            issues = (0, issue_check_2.default)(node);
            break;
        }
        case (0, issue_check_3.isDeviceNodeProperties)(node): {
            issues = (0, issue_check_3.default)(node);
            break;
        }
        case (0, issue_check_4.isEventsCalendarNodeProperties)(node): {
            issues = (0, issue_check_4.default)(node);
            break;
        }
        case (0, issue_check_5.isEventsStateNodeProperties)(node): {
            issues = (0, issue_check_5.default)(node);
            break;
        }
        case (0, issue_check_6.isGetHistoryNodeProperties)(node): {
            issues = (0, issue_check_6.default)(node);
            break;
        }
        case (0, issue_check_7.isPollStateNodeProperties)(node): {
            issues = (0, issue_check_7.default)(node);
            break;
        }
        case (0, issue_check_8.isTagNodeProperties)(node): {
            issues = (0, issue_check_8.default)(node);
            break;
        }
        case (0, issue_check_9.isTimeNodeProperties)(node): {
            issues = (0, issue_check_9.default)(node);
            break;
        }
        case (0, issue_check_10.isTriggerStateProperties)(node): {
            issues = (0, issue_check_10.default)(node);
            break;
        }
        case (0, issue_check_11.isWaitUntilNodeProperties)(node): {
            issues = (0, issue_check_11.default)(node);
            break;
        }
        case (0, issue_check_12.isZoneNodeProperties)(node): {
            issues = (0, issue_check_12.default)(node);
            break;
        }
    }
    if (issues.length) {
