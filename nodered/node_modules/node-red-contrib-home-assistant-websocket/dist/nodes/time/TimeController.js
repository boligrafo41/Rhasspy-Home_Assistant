...
class TimeController extends ExposeAsController {
    ...
    async onStateChanged() {
        ...
        const nextTime = __classPrivateFieldGet(this, _TimeController_instances, "m", _TimeController_formatDate).call(this, (_a = __classPrivateFieldGet(this, _TimeController_cronjob, "f")) === null || _a === void 0 ? void 0 : _a.nextDate().toJSDate());
...
_TimeController_cronjob = new WeakMap(), _TimeController_instances = new WeakSet(), _TimeController_createCronjob = function _TimeController_createCronjob(crontab) {
    ...
    __classPrivateFieldSet(this, _TimeController_cronjob, cron_1.CronJob.from({
        cronTime: crontab,
        onTick: async () => {
            try {
    ...
    if (__classPrivateFieldGet(this, _TimeController_cronjob, "f") != null) {
        this.node.debug(`Destroying cronjob: ${(_a = __classPrivateFieldGet(this, _TimeController_cronjob, "f")) === null || _a === void 0 ? void 0 : _a.nextDate().toJSDate()}`);
