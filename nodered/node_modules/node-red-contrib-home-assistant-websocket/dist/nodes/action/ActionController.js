...
class ActionController extends InputOutputController_1.default {
    ...
    async onInput({ message, parsedMessage, send, done, }) {
        ...
        if (((_a = parsedMessage.action) === null || _a === void 0 ? void 0 : _a.value) &&
            ...
            const [domain, service] = (_b = parsedMessage.action) === null || _b === void 0 ? void 0 : _b.value.toLowerCase().split('.');
            if (((_e = (_d = (_c = services[domain]) === null || _c === void 0 ? void 0 : _c[service]) === null || _d === void 0 ? void 0 : _d.fields) === null || _e === void 0 ? void 0 : _e.entity_id) !== undefined &&
