...
var _Websocket_instances, _Websocket_config, _Websocket_eventBus, _Websocket_servicesLoaded, _Websocket_statesLoaded, _Websocket_stopHeartbeat, _Websocket_subscribedEvents, _Websocket_unsubCallback, _Websocket_isAreaRegistryLoaded, _Websocket_isDeviceRegistryLoaded, _Websocket_isEntityRegistryLoaded, _Websocket_isFloorRegistryLoaded, _Websocket_isLabelRegistryLoaded, _Websocket_isAllRegistriesLoaded, _Websocket_emitEvent, _Websocket_checkHomeAssistantVersion, _Websocket_checkUserType, _Websocket_clientEvents, _Websocket_haEvents, _Websocket_checkIfAllRegistriesLoaded, _Websocket_onHomeAssistantRunning, _Websocket_integrationEvent;
...
(function (ClientEvent) {
    ...
    ClientEvent["InitialConnectionReady"] = "initial_connection_ready";
    ClientEvent["Integration"] = "integration";
    ClientEvent["Open"] = "ha_client:open";
    ClientEvent["Ready"] = "ha_client:ready";
    ClientEvent["RegistriesLoaded"] = "ha_client:registries_loaded";
...
class Websocket {
    constructor(config, eventBus) {
        ...
        _Websocket_isAreaRegistryLoaded.set(this, false);
        _Websocket_isDeviceRegistryLoaded.set(this, false);
        _Websocket_isEntityRegistryLoaded.set(this, false);
        _Websocket_isFloorRegistryLoaded.set(this, false);
        _Websocket_isLabelRegistryLoaded.set(this, false);
        _Websocket_isAllRegistriesLoaded.set(this, false);
        this.areas = [];
        this.devices = [];
        this.entities = [];
        this.floors = [];
        ...
        __classPrivateFieldGet(this, _Websocket_eventBus, "f").on(ClientEvent.Connecting, this.onClientConnecting.bind(this));
    ...
    get isStatesLoaded() {
        return __classPrivateFieldGet(this, _Websocket_statesLoaded, "f");
    }
    async connect() {
        ...
        this.client = await (0, home_assistant_js_websocket_1.createConnection)({
            ...
            __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, ClientEvent.Error);
        ...
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_checkHomeAssistantVersion).call(this);
        this.onClientOpen();
        // emit connected for only the first connection to the server
        // so we can setup certain things only once like registerEvents
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, ClientEvent.Connected);
    ...
    get isAllRegistriesLoaded() {
        return __classPrivateFieldGet(this, _Websocket_isAllRegistriesLoaded, "f");
    }
    async subscribeEvents(events) {
        ...
        currentEvents.add(_1.HaEvent.StateChanged);
        currentEvents.add(_1.HaEvent.TagScanned);
    ...
    onClientStates(entities) {
        ...
        if (!__classPrivateFieldGet(this, _Websocket_statesLoaded, "f")) {
            ...
            __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, ClientEvent.StatesLoaded, this.states);
            __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_checkIfAllRegistriesLoaded).call(this);
        }
    }
    onClientServices(services) {
        ...
        if (!__classPrivateFieldGet(this, _Websocket_servicesLoaded, "f")) {
            ...
            __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, ClientEvent.ServicesLoaded);
            __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_checkIfAllRegistriesLoaded).call(this);
        }
    }
    onStatesLoadedAndRunning(event = ClientEvent.Ready) {
        const statesLoaded = new Promise((resolve) => {
            __classPrivateFieldGet(this, _Websocket_eventBus, "f").once(ClientEvent.ServicesLoaded, resolve);
        });
        const homeAssinstantRunning = new Promise((resolve) => {
            __classPrivateFieldGet(this, _Websocket_eventBus, "f").once(ClientEvent.Running, resolve);
        });
        Promise.all([statesLoaded, homeAssinstantRunning]).then(([states]) => {
            __classPrivateFieldGet(this, _Websocket_eventBus, "f").emit(event, states);
        });
    }
    onClientEvents(hassEvent) {
        ...
        if (eventType === _1.HaEvent.StateChanged) {
            ...
            if (state && entityId) {
                ...
                debug(`Not processing ${_1.HaEvent.StateChanged} event: ${JSON.stringify(event)}`);
                return;
            }
        }
    ...
    onClientOpen() {
        ...
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, ClientEvent.Open);
    }
    onClientClose() {
    ...
    onClientError(data) {
        ...
        debug(data);
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, ClientEvent.Error, data);
        this.resetClient();
    }
    onClientConnecting() {
    ...
    resetClient() {
        ...
        __classPrivateFieldSet(this, _Websocket_isAreaRegistryLoaded, false, "f");
        __classPrivateFieldSet(this, _Websocket_isDeviceRegistryLoaded, false, "f");
        __classPrivateFieldSet(this, _Websocket_isEntityRegistryLoaded, false, "f");
        __classPrivateFieldSet(this, _Websocket_isFloorRegistryLoaded, false, "f");
        __classPrivateFieldSet(this, _Websocket_isLabelRegistryLoaded, false, "f");
        this.connectionState = ClientState.Disconnected;
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, ClientEvent.Close);
    }
    getAreas(areaId) {
        if (typeof areaId === 'string') {
            this.getArea(areaId);
        }
        return (0, lodash_1.cloneDeep)(this.areas);
    }
    getArea(areaId) {
        return (0, lodash_1.cloneDeep)(this.areas.find((area) => area.area_id === areaId));
    }
    getDevices(deviceId) {
        if (typeof deviceId === 'string') {
            this.getDevice(deviceId);
        }
        return (0, lodash_1.cloneDeep)(this.devices);
    }
    getDevice(deviceId) {
        return (0, lodash_1.cloneDeep)(this.devices.find((device) => device.id === deviceId));
    }
    ...
    getEntities(entityId) {
        ...
        return (0, lodash_1.cloneDeep)(this.entities);
    }
    getEntity(entityId) {
        return (0, lodash_1.cloneDeep)(this.entities.find((entity) => entity.entity_id === entityId));
    }
    getFloors(floorId) {
        if (typeof floorId === 'string') {
            this.getFloor(floorId);
        }
        return (0, lodash_1.cloneDeep)(this.floors);
    }
    getFloor(floorId) {
        return (0, lodash_1.cloneDeep)(this.floors.find((floor) => floor.floor_id === floorId));
    }
    getLabels(labelId) {
        if (typeof labelId === 'string') {
            this.getLabels(labelId);
        }
        return (0, lodash_1.cloneDeep)(this.labels);
    }
    getLabel(labelId) {
        return (0, lodash_1.cloneDeep)(this.labels.find((label) => label.label_id === labelId));
    }
    getStates(entityId) {
        if (typeof entityId === 'string') {
    ...
    getTag(tagId) {
        var _a;
        return (0, lodash_1.cloneDeep)((_a = this.tags) === null || _a === void 0 ? void 0 : _a.find((tag) => tag.id === tagId));
    }
    ...
    callService(domain, service, data, target) {
        ...
        const returnResponse = (0, createSocket_1.atLeastHaVersion)(this.client.haVersion, 2023, 12)
            ? !!((_b = (_a = services[domain]) === null || _a === void 0 ? void 0 : _a[service]) === null || _b === void 0 ? void 0 : _b.response)
            : undefined;
        const serviceCall = {
            type: 'call_service',
            domain,
...
_Websocket_config = new WeakMap(), _Websocket_eventBus = new WeakMap(), _Websocket_servicesLoaded = new WeakMap(), _Websocket_statesLoaded = new WeakMap(), _Websocket_stopHeartbeat = new WeakMap(), _Websocket_subscribedEvents = new WeakMap(), _Websocket_unsubCallback = new WeakMap(), _Websocket_isAreaRegistryLoaded = new WeakMap(), _Websocket_isDeviceRegistryLoaded = new WeakMap(), _Websocket_isEntityRegistryLoaded = new WeakMap(), _Websocket_isFloorRegistryLoaded = new WeakMap(), _Websocket_isLabelRegistryLoaded = new WeakMap(), _Websocket_isAllRegistriesLoaded = new WeakMap(), _Websocket_instances = new WeakSet(), _Websocket_emitEvent = function _Websocket_emitEvent(event, data) {
    return __classPrivateFieldGet(this, _Websocket_eventBus, "f").emit(event, data);
}, _Websocket_checkHomeAssistantVersion = function _Websocket_checkHomeAssistantVersion() {
    const [major, minor, patch] = const_1.HA_MIN_VERSION.split('.').map(Number);
    if (!(0, createSocket_1.atLeastHaVersion)(this.client.haVersion, major, minor, patch)) {
        this.connectionState = ClientState.Error;
        this.client.close();
        throw new Error(globals_1.RED._('home-assistant.error.ha_version_not_supported', {
            version: this.client.haVersion,
            min_version: const_1.HA_MIN_VERSION,
        }));
    }
    ...
    (0, collections_1.subscribeAreaRegistry)(this.client, (areas) => {
        __classPrivateFieldSet(this, _Websocket_isAreaRegistryLoaded, true, "f");
        this.areas = areas;
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_checkIfAllRegistriesLoaded).call(this);
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, _1.HaEvent.AreaRegistryUpdated, areas);
    });
    (0, collections_1.subscribeDeviceRegistry)(this.client, (devices) => {
        __classPrivateFieldSet(this, _Websocket_isDeviceRegistryLoaded, true, "f");
        this.devices = devices;
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_checkIfAllRegistriesLoaded).call(this);
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, _1.HaEvent.DeviceRegistryUpdated, devices);
    });
    (0, collections_1.subscribeEntityRegistry)(this.client, (entities) => {
        __classPrivateFieldSet(this, _Websocket_isEntityRegistryLoaded, true, "f");
        this.entities = entities;
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_checkIfAllRegistriesLoaded).call(this);
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, _1.HaEvent.EntityRegistryUpdated, entities);
    });
    (0, collections_1.subscribeFloorRegistry)(this.client, (floors) => {
        __classPrivateFieldSet(this, _Websocket_isFloorRegistryLoaded, true, "f");
        this.floors = floors;
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_checkIfAllRegistriesLoaded).call(this);
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, _1.HaEvent.FloorRegistryUpdated, floors);
    });
    (0, collections_1.subscribeLabelRegistry)(this.client, (labels) => {
        __classPrivateFieldSet(this, _Websocket_isLabelRegistryLoaded, true, "f");
        this.labels = labels;
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_checkIfAllRegistriesLoaded).call(this);
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, _1.HaEvent.LabelRegistryUpdated, labels);
    });
}, _Websocket_checkIfAllRegistriesLoaded = function _Websocket_checkIfAllRegistriesLoaded() {
    if (!__classPrivateFieldGet(this, _Websocket_isAllRegistriesLoaded, "f") &&
        __classPrivateFieldGet(this, _Websocket_isAreaRegistryLoaded, "f") &&
        __classPrivateFieldGet(this, _Websocket_isDeviceRegistryLoaded, "f") &&
        __classPrivateFieldGet(this, _Websocket_isEntityRegistryLoaded, "f") &&
        __classPrivateFieldGet(this, _Websocket_isFloorRegistryLoaded, "f") &&
        __classPrivateFieldGet(this, _Websocket_isLabelRegistryLoaded, "f") &&
        this.isStatesLoaded &&
        __classPrivateFieldGet(this, _Websocket_servicesLoaded, "f") &&
        this.isHomeAssistantRunning) {
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, ClientEvent.RegistriesLoaded);
        __classPrivateFieldSet(this, _Websocket_isAllRegistriesLoaded, true, "f");
    }
    ...
    if (!this.isHomeAssistantRunning) {
        ...
        __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_emitEvent).call(this, ClientEvent.Running);
